...
type AstroUserConfig = import('astro/dist/@types/astro.js').AstroUserConfig;
type AstroInlineConfig = import('astro/dist/@types/astro.js').AstroInlineConfig;
type ImageServiceConfig = import('astro/dist/@types/astro.js').ImageServiceConfig;
type SharpImageServiceConfig = import('astro/dist/assets/services/sharp.js').SharpImageServiceConfig;
type EnvField = typeof import('astro/dist/env/config.js').envField;
