import type { SSRResult } from 'astro/dist/@types/astro.js';
import { renderTemplate } from 'astro/dist/runtime/server/render/astro/render-template.js';
import type { RenderInstruction } from 'astro/dist/runtime/server/render/instruction.js';
import { HTMLString } from 'astro/dist/runtime/server/escape.js';
import { type RenderInstance } from 'astro/dist/runtime/server/render/common.js';
