...
import type { ActionAccept, ActionClient, ActionReturnType } from 'astro/dist/actions/runtime/virtual/server.js';
import type { RemotePattern } from 'astro/dist/assets/utils/remotePattern.js';
import type { DataEntry, RenderedContent } from 'astro/dist/content/data-store.js';
import type { AssetsPrefix, SSRManifest, SerializedSSRManifest } from 'astro/app/types.js';
import type { PageBuildData } from 'astro/dist/core/build/types.js';
import type { AstroConfigType } from 'astro/dist/core/config/index.js';
import type { AstroTimer } from 'astro/dist/core/config/timer.js';
import type { TSConfig } from 'astro/dist/core/config/tsconfig.js';
import type { AstroCookies } from 'astro/dist/core/cookies/index.js';
import type { AstroIntegrationLogger, Logger, LoggerLevel } from 'astro/dist/core/logger/core.js';
import type { EnvSchema } from 'astro/dist/env/schema.js';
import type { getToolbarServerCommunicationHelpers } from 'astro/dist/integrations/hooks.js';
import type { AstroPreferences } from 'astro/dist/preferences/index.js';
import type { ToolbarAppEventTarget, ToolbarServerHelpers } from 'astro/dist/runtime/client/dev-toolbar/helpers.js';
import type { AstroDevToolbar, DevToolbarCanvas } from 'astro/dist/runtime/client/dev-toolbar/toolbar.js';
import type { Icon } from 'astro/dist/runtime/client/dev-toolbar/ui-library/icons.js';
import type { DevToolbarBadge, DevToolbarButton, DevToolbarCard, DevToolbarHighlight, DevToolbarIcon, DevToolbarRadioCheckbox, DevToolbarSelect, DevToolbarToggle, DevToolbarTooltip, DevToolbarWindow } from 'astro/dist/runtime/client/dev-toolbar/ui-library/index.js';
import type { AstroComponentFactory, AstroComponentInstance } from 'astro/dist/runtime/server/index.js';
import type { TransitionBeforePreparationEvent, TransitionBeforeSwapEvent } from 'astro/dist/transitions/events.js';
import type { DeepPartial, OmitIndexSignature, Simplify } from 'astro/dist/type-utils.js';
import type { REDIRECT_STATUS_CODES, SUPPORTED_MARKDOWN_FILE_EXTENSIONS } from 'astro/dist/core/constants.js';
...
export type { ExternalImageService, ImageService, LocalImageService, } from 'astro/dist/assets/services/service.js';
export type { GetImageResult, ImageInputFormat, ImageMetadata, ImageOutputFormat, ImageQuality, ImageQualityPreset, ImageTransform, UnresolvedImageTransform, } from 'astro/dist/assets/types.js';
export type { RemotePattern } from 'astro/dist/assets/utils/remotePattern.js';
export type { AssetsPrefix, SSRManifest } from 'astro/app/types.js';
export type { AstroCookieGetOptions, AstroCookieSetOptions, AstroCookies, } from 'astro/dist/core/cookies/index.js';
